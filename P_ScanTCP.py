...
class PScan:
    ...
    def show_completion_message(self):
        print()
        if self.open_ports:
            console.print("Scan Completed. Open Ports:", style="bold cyan")
    ...
    def show_startup_message():
        ascii_art = pyfiglet.figlet_format("+ PScanTCP +")
        console.print(f"[bold green]{ascii_art}[/bold green]")
        console.print("•" * 59, style="bold white")
        console.print(
            "•" * 11, "Simple MultiThread TCP Port Scanner", "•" * 11, style="bold green"
        )
        console.print("•" * 59, style="bold white")
        print()
    ...
    def get_host_ip_addr(target):
        try:
            ...
            sys.exit()
        console.print(f"\nIP address acquired: [bold cyan]{ip_addr}[/bold cyan]")
        return ip_addr
    ...
    def initialize(self):
        ...
        self.get_ports_info()
        try:
            target = console.input("[bold cyan]Target: ")
